...
- Menu: https://morvakoffi.co.uk/menu
...
- Facebook: https://www.facebook.com/morvakoffi
- Instagram: https://instagram.com/morvakoffi

Used for: visitor path to live weather and opening updates. Search results showed a recent weather-related closure update, supporting the site's explicit weather notice.

## Local Copies

The raw HTML captures are saved in this folder for traceability:

- `oldsite-home.html`
- `oldsite-menu.html`
- `oldsite-findus.html`
- `oldsite-faq.html`
- `st-ives-coffee-shops-2025.html`
